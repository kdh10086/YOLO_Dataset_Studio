...
def train_model(config, args):
    ...
    dataset_dir_rel = args.dataset or INIT_DATASET_DIR or config['dataset_paths']['initial_labeled_dataset']
    ...
    print("\n" + "="*50); print("Starting YOLO Model Training. (Phase 1: Initial Teacher)"); print("="*50)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Trains the YOLO Teacher model.")
